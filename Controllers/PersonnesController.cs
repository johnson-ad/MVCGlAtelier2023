...
namespace MVCGlAtelier2023.Controllers
{
    public class PersonnesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IdPers,NomPers,PrenomPers,AdressePers,EmailPers")] Personne personne)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IdPers,NomPers,PrenomPers,AdressePers,EmailPers")] Personne personne)
        {
            if (ModelState.IsValid)
            {
